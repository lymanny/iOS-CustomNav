...
extension UIViewController {
    ...
    private func createTitleStackView(titleConfig: NavigationTitleConfig, subtitleConfig: NavigationSubtitleConfig?, titleSubtitleSpacing: CGFloat) -> UIView {
    ...
    private func createNavigationBarButtons(_ buttons: [NavigationButtonConfig], spacing: CGFloat) -> [UIBarButtonItem] {
    ...
    private func createButton(from config: NavigationButtonConfig) -> UIButton {
